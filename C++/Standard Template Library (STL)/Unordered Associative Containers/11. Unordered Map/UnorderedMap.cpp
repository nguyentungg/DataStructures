...
// - unordered_map containers are faster than map to access individual elements by their key, 
//   although they are generally less efficient for range iteration through a subset of their elements.
#include <unordered_map>

std::unordered_map<std::string,int> m, mo;
std::pair<std::unordered_map<string,int>::iterator,bool> it;
//---------------------------------
// General Operations
//---------------------------------
